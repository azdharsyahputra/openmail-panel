    ...
    <div className="space-y-6 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5">
        ...
        >
          ...
          <div className="text-2xl font-bold text-zinc-950 font-mono mt-1 tracking-tight">{domains.length}</div>
        </div>
        ...
        >
          ...
          <div className="text-2xl font-bold text-zinc-950 font-mono mt-1 tracking-tight">{mailboxes.length}</div>
        </div>
        ...
        >
          ...
          <div className="text-2xl font-bold text-zinc-950 font-mono mt-1 tracking-tight">{queueSummary?.total || 0}</div>
        </div>
        ...
        >
          <div className="flex justify-between items-baseline">
            ...
            <span className="text-[11px] font-mono text-zinc-500">of {formatBytes(totalQuotaBytes)}</span>
          </div>
          <div className="text-2xl font-bold text-zinc-950 font-mono mt-1 tracking-tight">{formatBytes(totalUsedBytes)}</div>
        </div>
      </div>
