  ...
  return (
    <div className="space-y-6 max-w-6xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200/80 pb-4">
        <div>
          <h1 className="text-lg font-bold text-slate-900 tracking-tight">Identity & Directory (LDAP)</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        {/* Provider Status */}
        <div className="rounded-xl border border-slate-200/80 bg-white p-5 space-y-3 font-mono text-xs shadow-2xs">
        ...
        <div className="lg:col-span-2 rounded-xl border border-slate-200/80 bg-white overflow-hidden shadow-2xs">
          <div className="px-4 py-3 bg-slate-50/70 border-b border-slate-100 text-xs font-bold text-slate-800 font-mono uppercase tracking-wider">
            LDAP Group $\rightarrow$ Role Mapping
          </div>
          <table className="w-full text-left text-xs font-mono">
            <tbody className="divide-y divide-slate-100">
              <tr className="hover:bg-slate-50/50 transition-colors">
                <td className="py-2.5 px-4 font-semibold text-slate-800">cn=mail-admins,ou=groups,dc=...</td>
                <td className="py-2.5 px-4 text-blue-600 font-bold">ADMIN</td>
                <td className="py-2.5 px-4 text-slate-500 font-sans">Full control plane mutations & system</td>
              </tr>
              <tr className="hover:bg-slate-50/50 transition-colors">
                <td className="py-2.5 px-4 font-semibold text-slate-800">cn=mail-operators,ou=groups,dc=...</td>
                <td className="py-2.5 px-4 text-indigo-600 font-bold">OPERATOR</td>
                <td className="py-2.5 px-4 text-slate-500 font-sans">Queue retry/hold, mailbox suspend/resume</td>
              </tr>
              <tr className="hover:bg-slate-50/50 transition-colors">
                <td className="py-2.5 px-4 font-semibold text-slate-800">cn=mail-auditors,ou=groups,dc=...</td>
                <td className="py-2.5 px-4 text-slate-700 font-bold">AUDITOR</td>
                <td className="py-2.5 px-4 text-slate-500 font-sans">Read-only audit logs & system health</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <div className="rounded-xl border border-slate-200/80 bg-white p-5 space-y-4 shadow-2xs">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 text-xs bg-slate-50 border border-slate-300 rounded-lg focus:outline-none focus:bg-white focus:border-zinc-900 font-mono"
            />
          </div>
          ...
          <div className="flex items-center justify-between gap-3 pt-6">
            ...
            <button
              ...
              disabled={syncing}
              className="flex items-center gap-1.5 px-4 py-2 text-xs font-medium bg-zinc-900 hover:bg-zinc-800 text-white rounded-lg disabled:opacity-50 cursor-pointer shadow-xs"
            >
        ...
        {/* Sync Report */}
        {syncReport && (
          <div className="p-4 bg-slate-50/70 border border-slate-200/80 rounded-xl text-xs font-mono space-y-3 mt-4">
            ...
            <div className="grid grid-cols-5 gap-3 text-center">
              <div className="p-2.5 bg-white rounded-lg border border-slate-200 shadow-2xs">
                ...
                <div className="text-sm font-bold text-slate-800 mt-0.5">{syncReport.total_identities}</div>
              </div>
              <div className="p-2.5 bg-white rounded-lg border border-slate-200 shadow-2xs">
              ...
              <div className="p-2.5 bg-white rounded-lg border border-slate-200 shadow-2xs">
                ...
                <div className="text-sm font-bold text-slate-600 mt-0.5">{syncReport.skipped}</div>
              </div>
            </div>
          </div>
        )}
